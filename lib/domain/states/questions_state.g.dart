...
class _$QuestionsState extends QuestionsState {
  ...
  factory _$QuestionsState([void updates(QuestionsStateBuilder b)]) =>
      (new QuestionsStateBuilder()..update(updates)).build();

  _$QuestionsState._({this.questions}) : super._();

  @override
  QuestionsState rebuild(void updates(QuestionsStateBuilder b)) =>
...
class QuestionsStateBuilder
  ...
  @override
  void update(void updates(QuestionsStateBuilder b)) {
